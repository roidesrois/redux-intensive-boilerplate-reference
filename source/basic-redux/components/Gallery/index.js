...
export default class Gallery extends Component {
    ...
    render () {
        ...
        } = store.getState(); // сперва написать как полный state

        const { url } = photos.find((_, photoIndex) => photoIndex === selectedPhotoIndex); // сперва написать через точку для понятности
